...
namespace {
struct qt_meta_tag_ZN7EllipseE_t {};
} // unnamed namespace

template <> constexpr inline auto Ellipse::qt_create_metaobjectdata<qt_meta_tag_ZN7EllipseE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<Ellipse, qt_meta_tag_ZN7EllipseE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Ellipse::staticMetaObject = { {
    QMetaObject::SuperData::link<Figure::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7EllipseE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7EllipseE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN7EllipseE_t>.metaTypes,
    nullptr
} };
...
void *Ellipse::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7EllipseE_t>.strings))
