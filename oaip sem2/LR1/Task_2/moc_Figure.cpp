...
template <> constexpr inline auto Figure::qt_create_metaobjectdata<qt_meta_tag_ZN6FigureE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'figureChanged'
        QtMocHelpers::SignalData<void()>(1, 2, QMC::AccessPublic, QMetaType::Void),
        // Signal 'animationProgress'
...
void Figure::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->figureChanged(); break;
        case 1: _t->animationProgress((*reinterpret_cast<std::add_pointer_t<double>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Figure::*)()>(_a, &Figure::figureChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Figure::*)(double )>(_a, &Figure::animationProgress, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (Figure::*)()>(_a, &Figure::animationFinished, 2))
            return;
    }
}
...
// SIGNAL 1
void Figure::animationProgress(double _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 1, nullptr, _t1);
}

// SIGNAL 2
void Figure::animationFinished()
{
